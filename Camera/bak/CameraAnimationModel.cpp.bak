...
#include		"../Include/AnimationModel.h"
...
CAnimationModel::CAnimationModel( LPCTSTR	lpszXFileName )
{
	m_pXFileName	= NULL;
	m_pd3dDevice	= NULL;
	m_pFrameRoot	= NULL;
...
HRESULT	CAnimationModel::RestoreDeviceObjects()
{
	HRESULT	hr	= S_OK;
...
HRESULT	CAnimationModel::InvalidateDeviceObjects()
{
	HRESULT	hr	= S_OK;
...
HRESULT	CAnimationModel::DeleteDeviceObjects()
{
	HRESULT	hr	= S_OK;
...
HRESULT	CAnimationModel::DrawMeshContainerByIndexed(LPD3DXMESHCONTAINER pSuperMeshContainer)
{
	HRESULT	hr = S_OK;
...
HRESULT	CAnimationModel::DrawMeshContainerByVS(LPD3DXMESHCONTAINER pSuperMeshContainer)
{
	HRESULT	hr = S_OK;
...
HRESULT	CAnimationModel::DrawMeshContainerByHLSL(LPD3DXMESHCONTAINER pSuperMeshContainer)
{
	HRESULT	hr = S_OK;
...
HRESULT	CAnimationModel::DrawMeshContainerBySW(LPD3DXMESHCONTAINER pSuperMeshContainer)
{
	HRESULT	hr = S_OK;
...
LRESULT	CAnimationModel::HandleMessages( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
